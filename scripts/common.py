"""Shared utilities for Brindal & Grayson Ultimate Cow Pack build pipeline."""
...
PACK_NAME_RP = "Brindal & Grayson Ultimate Cow Pack"
PACK_NAME_BP = "Brindal & Grayson Ultimate Cow BP"

# Entities that should NOT be transformed or re-textured as cows
COW_IDENTIFIERS = {
    "minecraft:cow",
    "minecraft:mooshroom",
}
